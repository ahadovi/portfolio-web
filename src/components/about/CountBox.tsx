...
const CountBox: React.FC<CountBoxProps> = ({ children, textUp, textDown }) => {
  return (
    <div className="bg-bgInactiveLight dark:bg-bgInactiveDark p-4 md:p-6 rounded-md">
      <h3 className="text-lime-600 dark:text-amber-500 text-4xl md:text-5xl font-bold flex gap-x-1.5">
        {children}
        <span className="font-normal text-3xl md:text-4xl">+</span>
      </h3>
